...
GLuint VAORanderLightingMaps:: createTexture(char const * path, GLint param) {
    GLuint texture;
...
void VAORanderLightingMaps::createVAO() {
...
void VAORanderLightingMaps::beforeRander(GLuint program, GLuint lightProgram) {
...
void VAORanderLightingMaps::rander(GLuint program, GLuint lightProgram) {
