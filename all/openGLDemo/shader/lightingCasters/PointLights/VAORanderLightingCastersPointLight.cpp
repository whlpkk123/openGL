//
//  VAORanderLightingCastersPointLight.cpp
//  openGLDemo
//
...
GLuint VAORanderLightingCastersPointLight:: createTexture(char const * path, GLint param) {
    GLuint texture;
...
void VAORanderLightingCastersPointLight::createVAO() {
...
void VAORanderLightingCastersPointLight::beforeRander(GLuint program, GLuint lightProgram) {
...
void VAORanderLightingCastersPointLight::rander(GLuint program, GLuint lightProgram) {
...
//    glBindTexture(GL_TEXTURE_2D, _texture3);
    ...
    setVec3(program, "light.position",  _lightPos);
