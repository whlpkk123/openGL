//
//  VAORanderLightingCastersSpotlight.cpp
//  openGLDemo
//
...
GLuint VAORanderLightingCastersSpotlight:: createTexture(char const * path, GLint param) {
    GLuint texture;
...
void VAORanderLightingCastersSpotlight::createVAO() {
    ...
    _texture3 = createTexture("lightingMaps/matrix.jpg", GL_REPEAT);
}

void VAORanderLightingCastersSpotlight::beforeRander(GLuint program, GLuint lightProgram) {
    ...
    setFloat(program, "light.constant",  1.0f);
    setFloat(program, "light.linear",    0.09f);
    setFloat(program, "light.quadratic", 0.032f);
    
    setFloat(program, "light.cutOff",  glm::cos(glm::radians(12.5f)));
    setFloat(program, "light.outerCutOff",  glm::cos(glm::radians(17.5f)));
}


void VAORanderLightingCastersSpotlight::rander(GLuint program, GLuint lightProgram) {
...
//    glBindTexture(GL_TEXTURE_2D, _texture3);
    ...
    setVec3(program, "light.position",  _camera->Position);
    setVec3(program, "light.direction",  _camera->Front);
