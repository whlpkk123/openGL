//
//  VAORanderLightingCastersDirectionalLight.cpp
//  openGLDemo
//
...
GLuint VAORanderLightingCastersDirectionalLight:: createTexture(char const * path, GLint param) {
    GLuint texture;
...
void VAORanderLightingCastersDirectionalLight::createVAO() {
...
void VAORanderLightingCastersDirectionalLight::beforeRander(GLuint program, GLuint lightProgram) {
    ...
    setVec3(program, "light.direction",  -0.2f, -1.0f, -0.3f);
...
void VAORanderLightingCastersDirectionalLight::rander(GLuint program, GLuint lightProgram) {
