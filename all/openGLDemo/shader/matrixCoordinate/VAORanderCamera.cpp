...
GLuint VAORanderCamera:: createTexture(char const * path, GLuint pixelFormat, GLint param) {
    GLuint texture;
...
void VAORanderCamera::createVAO() {
...
void VAORanderCamera::beforeRander(GLuint program) {
...
void VAORanderCamera::rander(GLuint program) {
...
void VAORanderCamera::processInputEvent(GLFWwindow *window, int key, int scanCode, int action, int mods) {
